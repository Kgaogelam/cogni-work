  ...
  head: () => ({
    meta: [
      ...
      { title: "WorkFlow AI — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Work smarter, communicate faster and plan better with WorkFlow AI: email drafting, meeting summaries, task planning and research in one workspace.",
      },
      { name: "author", content: "WorkFlow AI" },
      { property: "og:title", content: "WorkFlow AI — AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "One AI workspace for emails, meetings, tasks and research.",
      },
